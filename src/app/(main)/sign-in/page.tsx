...
import CheckIcon from "@/images/sign-in/check.svg";
      ...
      <div className="mx-auto max-w-[1340px]">
        <div className="flex flex-col w-full pt-[0.875rem] pb-[6.25rem] px-5">
          ...
          <div className="flex flex-col items-center md:flex-row md:justify-between md:items-start">
            <section className="flex flex-col w-full md:max-w-[536px] mb-6 md:mb-0 md:mr-5">
              ...
              <SignInForm />
              <Link href="/account" className="text-[#0e2eed] text-center mb-2">
                {" "}
                Quên mật khẩu?
              </Link>
              ...
              <div className="text-center text-[#121212] mb-4 lg:mb-0">
                ...
                <Link href="/sign-up" className="text-[#0e2eed]">
                  {" "}
                  Đăng ký ngay
                </Link>
              </div>
            ...
            <section className="flex flex-col max-w-[670px]">
              <h1 className="text-[#121212] font-bold text-xl lg:text-2xl my-4 lg:mb-4">
              ...
              <div className="flex flex-col gap-4">
                {specialFeatures.map((feature, index): any => (
                  <div
                    key={index}
                    className="flex items-start text-[#121212] text-base"
                  >
                    <Image
                      src={CheckIcon}
                      width={0}
                      height={0}
                      className="w-4 h-4 shrink-0 mt-[6px]"
                      alt=""
                    />
