...
const schema = yup.object().shape({
  school: yup.string().required("Vui lòng điền tên trường của bạn"),
  major: yup.string().required("Vui lòng điền tên ngành học"),
  startDate: yup
    .string()
    .matches(
      new RegExp(/^(0[1-9]|1[0-2])\/\d{4}$/),
          ...
          <div className="flex flex-col gap-10 pt-6 pb-20  pr-6 pl-8 max-h-[400px] overflow-auto text-primary-black">
            <div className="relative flex flex-col gap-2">
              ...
              <input
                ...
                id="school"
                placeholder="Đại học Sư Phạm Kỹ Thuật TPHCM"
