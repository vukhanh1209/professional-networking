...
export default function FormWrapper({children, title, onClose, onSave, handleSubmit} : FormWrapperProps) {
    
    return (
        <div className="fixed top-0 left-0 right-0 flex items-center justify-center w-full h-screen bg-blur-form z-[100] px-10">
                    <form onSubmit={handleSubmit(onSave)} className="h-fit w-full md:max-w-[50%] bg-white rounded-lg">
