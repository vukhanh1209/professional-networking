...
import { closeFilterModal, deleteFilter, selectCandidateLevelFilter, selectCompanyTypeFilter, selectFilterCount, selectIsOpenFilterModal, selectJobTypeFilter } from "@/redux/reducers/searchSlice"
                        ...
                        <section className="h-fit w-full md:max-w-[50%] bg-white rounded-lg mt-10">
                            <div className="flex justify-between items-center border-b border-silver-grey py-4 px-8 ">
                                ...
                                <button className="p-2 hover:bg-light-grey rounded-full transition-all">
                                    <Image onClick={onCloseModal} width={32} height={32} src={CloseIcon} alt="close"/>
                                </button>
                            </div>
